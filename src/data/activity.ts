...
const events: ActivityType[] = [
  {
    ...
    description: [
      "[參觀海報展，一起加入學術派對！]",
      "。活動說明",
      "    。找到藏身於海報架中的 QR code 碼，點開「掃描器」掃描，即可獲得拼圖獎勵。",
      "    。活動地點：2F 梯廳",
      "    。可獲拼圖數：1 塊",
    ],
  },
  {
    ...
    description: [
      "[一杯咖啡、一場邂逅。]",
      "。活動說明",
      "    。找到藏身於咖啡廳中的 QR code 碼，點開「掃描器」掃描，即可獲得拼圖獎勵。",
      "    。活動地點：2F 梯廳",
      "    。可獲拼圖數：1 塊",
    ],
  },
  {
    ...
    description: [
      "[跟著導遊團走透透！]",
      "。活動說明",
      "    。在以下指定時間前 5 分鐘，於集合處找到拿著旗子的導遊…身旁的 SITCON 年會工作人員，點開「掃描器」掃描這位工人手上的 QR code 碼，即可獲得拼圖獎勵。",
      "    。活動地點：",
      "          。早上 11 點整 - 3F 白板區旁牆壁",
  ...
  },
  {
    ...
    description: [
      "[在白板大戰留下巨作！]",
      "。活動說明",
      "    。找到藏身於白板牆某處角落上的 QR code 碼，點開「掃描器」掃描，即可獲得拼圖獎勵。",
      "    。活動地點：3F 白板牆留言區",
      "    。可獲拼圖數：1 塊",
    ],
  },
...
const bonus: ActivityType[] = [
  {
    ...
    description: [
      "[迷因拼圖第一站新手村]",
      "。活動說明",
      "    。在 SITCON 2024 年會開幕式中，主持人將帶領大家步入迷因拼圖新手村。您會於投影幕上找到專屬的 QR code 碼，點開「掃描器」掃描此 QR code 碼，即可獲得第一塊拼圖獎勵。",
      "    。活動地點：R0",
      "    。可獲拼圖數：1 塊",
    ],
  },
  {
    ...
    description: [
      ...
      "    。將照片分享至任意社群平台，發文或限時動態，打卡標註 SITCON 2024，並於 13：00 後至 3F 講者服務台找到工作人員進行驗證，出示您的 QR code 碼即可獲得 Bonus 拼圖獎勵！",
      "    。活動地點：整個年會會場",
      "    。可獲拼圖數：1 塊",
    ],
  },
